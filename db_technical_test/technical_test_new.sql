...
CREATE DATABASE IF NOT EXISTS `technical_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `technical_test`;

-- Dumping structure for table technical_test.diagnosa_pasien
CREATE TABLE IF NOT EXISTS `diagnosa_pasien` (
  ...
  CONSTRAINT `diagnosa_kunjungan_id` FOREIGN KEY (`kunjungan_id`) REFERENCES `kunjungan_pasien` (`pendaftaran_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dokter` FOREIGN KEY (`m_dokter_id`) REFERENCES `master_dokter` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `m_diagnosa_id` FOREIGN KEY (`m_diagnosa_id`) REFERENCES `master_diagnosa` (`diagnosa_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table technical_test.diagnosa_pasien: ~100 rows (approximately)
...
-- Dumping structure for table technical_test.kunjungan_pasien
CREATE TABLE IF NOT EXISTS `kunjungan_pasien` (
  ...
  CONSTRAINT `bayar_id` FOREIGN KEY (`m_bayar_id`) REFERENCES `master_pembayaran` (`bayar_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dokter_id` FOREIGN KEY (`m_dokter_id`) REFERENCES `master_dokter` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pasien_id` FOREIGN KEY (`m_pasien_id`) REFERENCES `master_pasien` (`pasien_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `unit_id` FOREIGN KEY (`m_unit_id`) REFERENCES `master_unit` (`unit_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table technical_test.kunjungan_pasien: ~100 rows (approximately)
...
-- Dumping structure for table technical_test.master_diagnosa
...
-- Dumping data for table technical_test.master_diagnosa: ~10 rows (approximately)
...
-- Dumping structure for table technical_test.master_dokter
...
-- Dumping data for table technical_test.master_dokter: ~5 rows (approximately)
...
-- Dumping structure for table technical_test.master_hari
...
-- Dumping data for table technical_test.master_hari: ~7 rows (approximately)
...
-- Dumping structure for table technical_test.master_jadwal_dokter
CREATE TABLE IF NOT EXISTS `master_jadwal_dokter` (
  `jadwal_id` int(11) NOT NULL,
  `jadwal_dokter_id` int(11) NOT NULL,
  `jadwal_unit_id` int(11) NOT NULL,
...
-- Dumping data for table technical_test.master_jadwal_dokter: ~7 rows (approximately)
INSERT INTO `master_jadwal_dokter` (`jadwal_id`, `jadwal_dokter_id`, `jadwal_unit_id`, `jadwal_hari_id`, `jadwal_mulai`, `jadwal_selesai`) VALUES
	(1, 1, 1, 1, '08:00:00', '10:00:00'),
	(2, 2, 2, 2, '08:00:00', '10:00:00'),
	(3, 3, 3, 3, '12:00:00', '14:00:00'),
	(4, 4, 4, 4, '12:00:00', '14:00:00'),
	(5, 5, 1, 5, '12:00:00', '14:00:00'),
	(6, 1, 2, 6, '12:00:00', '14:00:00'),
	(7, 2, 3, 7, '12:00:00', '14:00:00');

-- Dumping structure for table technical_test.master_pasien
...
-- Dumping data for table technical_test.master_pasien: ~6 rows (approximately)
...
-- Dumping structure for table technical_test.master_pembayaran
...
-- Dumping data for table technical_test.master_pembayaran: ~4 rows (approximately)
...
-- Dumping structure for table technical_test.master_unit
...
-- Dumping data for table technical_test.master_unit: ~5 rows (approximately)
